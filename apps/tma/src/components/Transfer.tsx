                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    {!loading?<div className="p-4 md:p-5">
                        <form className="space-y-4" action="#">
                            ...
                            <FlexBoxRow>
                            <button onClick={transfer} className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Transfer</button>
                            <button onClick={()=>{CloseTransferModal()}} className="w-full p opacity-70 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Cancel</button>
                            </FlexBoxRow>
                        </form>
                    </div>:
                    ...
                    {!loading?<></>:
                        <button onClick={()=>{CloseTransferModal()}} className="my-5 w-10/12 p opacity-40 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Cancel</button>
                    }
                </div>
            </div>
